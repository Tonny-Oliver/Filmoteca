...
from .views import Homefilmes, Detalhefilme, Homecategoriaacao, Homecategoriaficcao, Homecategoriaanimacao, Homecategoriasuspense, Pesquisafilme, Homecategoriacomedia, Homecategoriadrama, Homecategoriadocumentario, Homecategoriaromance, Homecategoriaterror, Homecategoriatodos, TV
...
urlpatterns = [
    ...
    path('tv/<int:pk>', TV.as_view(), name='hometv'),
